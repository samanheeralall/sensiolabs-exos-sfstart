 ...
 */
final class Version20260414152701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE volunteering (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, conference_id INTEGER DEFAULT NULL, CONSTRAINT FK_7854E8EE604B8382 FOREIGN KEY (conference_id) REFERENCES conference (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__volunteering AS SELECT id, start_at, end_at FROM volunteering');
        $this->addSql('DROP TABLE volunteering');
        $this->addSql('CREATE TABLE volunteering (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO volunteering (id, start_at, end_at) SELECT id, start_at, end_at FROM __temp__volunteering');
        $this->addSql('DROP TABLE __temp__volunteering');
    }
}
